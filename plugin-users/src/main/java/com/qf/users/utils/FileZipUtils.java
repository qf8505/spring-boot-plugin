...
//        Process ps = Runtime.getRuntime().exec(" java -javaagent:C:\\work\\github\\springs-boot-plugin-test\\plugin-users\\target\\plugin-users-0.0.1-SNAPSHOT-encrypted.jar -jar C:\\work\\github\\springs-boot-plugin-test\\plugin-users\\target\\plugin-users-0.0.1-SNAPSHOT-encrypted.jar");
//
